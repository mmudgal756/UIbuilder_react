...
export const ApiBuilder: React.FC = () => {
  const { selectedApi, updateApi, runApi } = useAppStore();
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-3">
            <select
              ...
              onChange={(e) => updateApi(selectedApi.id, { method: e.target.value as any })}
            ...
            <input
              ...
              className="flex-1 min-w-96 px-3 py-1.5 bg-gray-700 border border-gray-600 rounded-md text-white text-sm"
                ...
                <div className="space-y-3">
                  <select
                    ...
                    onChange={(e) => updateApi(selectedApi.id, {
                      authentication: { ...selectedApi.authentication, type: e.target.value as any }
                    })}
          ...
          <div className="p-4">
            {selectedApi.isLoading ? (
              ...
              <div className="bg-gray-750 rounded-lg p-4">
                ...
                <pre className="text-sm text-gray-300 whitespace-pre-wrap overflow-auto max-h-96 bg-gray-800 p-3 rounded">
