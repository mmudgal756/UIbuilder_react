...
export const SettingsPanel: React.FC = () => {
  ...
  return (
    <div className="p-4 h-full overflow-y-auto text-gray-200">
            ...
            <div>
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    updateSettings({ responsive: e.target.checked })
                  }
                />
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  updateSettings({ fontSize: e.target.value as Settings["fontSize"] })
                }
                className="w-full p-2 bg-gray-700 border border-gray-600 rounded text-sm"
              >
